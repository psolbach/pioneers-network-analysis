...
curl 'https://api.twitter.com/1.1/users/search.json?q=Alexander+Lange' \
  ...
  -H 'user-agent: Mozilla/5.0 (Macintosh; Intel Mac OS X 10_14_6) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/97.0.4692.99 Safari/537.36' \
